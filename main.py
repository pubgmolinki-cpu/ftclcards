...
from aiohttp import web # Новый импорт для анти-сна
...
async def handle_photo(message: types.Message):
    if message.from_user.id == ADMIN_ID:
        ...
        await message.reply("📸 Фото сохранено. /add_player")
...
async def main():
    ...
    # Запускаем фоновый веб-сервер, чтобы Railway не отключал бота
